  ...
  return (
    <>
      <style>{`
        ...
        @media (max-width: 640px) { .article-back { display: none !important; } .article-main { padding-top: 16px !important; } .article-tag { font-size: 9px !important; } .article-date { font-size: 10px !important; } .article-byline { margin-bottom: 8px !important; } }
      `}</style>
