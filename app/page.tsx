    ...
    >
      <div style={{ position: 'relative', height: 500, overflow: 'hidden', borderRadius: 20, cursor: 'pointer' }}>
        ...
        <div style={{ position: 'absolute', top: 24, left: 24, display: 'flex', gap: 8 }}>
          ...
          <span style={{ background: 'rgba(0,0,0,0.55)', backdropFilter: 'blur(8px)', color: '#fff', fontSize: 10, fontWeight: 700, letterSpacing: 1.5, textTransform: 'uppercase', padding: '5px 10px', borderRadius: 6 }}>
