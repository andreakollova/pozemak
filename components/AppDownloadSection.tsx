    ...
    <div style={{ position: 'relative', background: 'linear-gradient(135deg, #000d3d 0%, #002da8 50%, #003ad0 100%)', padding: '45px 0 55px', overflow: 'hidden' }}>
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 32px', display: 'flex', alignItems: 'center', gap: 80, flexWrap: 'wrap', justifyContent: 'center' }}>
        ...
        <div style={{ flex: '1 1 340px', minWidth: 280 }}>
          ...
          {/* Features — 2 per row */}
          <div style={{ display: 'grid', gridTemplateColumns: 'auto auto', gap: 8, marginBottom: 32 }}>
          ...
          <a
            ...
            style={{ display: 'inline-flex', alignItems: 'center', gap: 10, background: '#ffffff', color: '#000000', borderRadius: 16, padding: '14px 26px', textDecoration: 'none', fontWeight: 800, fontSize: 15 }}
          >
