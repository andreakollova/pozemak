...
export default function CookieBanner() {
  ...
  function saveCustom() { saveConsent(consent) }
    ...
    <>
      <style>{`
        ...
        @media (max-width: 600px) {
          ...
          .cookie-compact { flex-direction: column; align-items: stretch; gap: 14px; }
          .cookie-buttons { flex-direction: column; }
          .cookie-buttons button { width: 100%; justify-content: center; }
          .cookie-row { flex-direction: column; align-items: flex-start; }
          .cookie-save-row { flex-direction: column; }
          .cookie-save-row button { width: 100%; }
        }
      `}</style>
